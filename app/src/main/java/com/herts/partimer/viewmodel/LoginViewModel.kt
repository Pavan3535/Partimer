...
import com.herts.partimer.repository.LoginRepository
...
class LoginViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var createUserLiveData:LiveData<SignupResponse>?=null
    ...
    fun createUser(signupRequest: SignupRequest){
        createUserLiveData = homeRepository?.createUser(signupRequest)
    }
